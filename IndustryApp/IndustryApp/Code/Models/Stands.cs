    ...
    public class Stands
    {
        ...
        public List<Stands> GetStands()
        {
            return new List<Stands>
            {
                ...
                new Stands {NumeroStand = 602, Nombre = "Thyssenkrupp Materials North America", NumeroNombre = NumeroStand.ToString() + " - " + Nombre},
                new Stands {NumeroStand = 602, Nombre = "Ken Mac Metals Division", NumeroNombre = NumeroStand.ToString() + " - " + Nombre},
